...
public class JDlgConsultaVendedor extends javax.swing.JDialog {
    ...
    Util util;
    ConsultaVendedor_efb consultarVendedor;
    VendedorDao_efb VendedorDao;
    List lista;
    private static final Logger LOGGER = Logger.getLogger(VendedorDao_efb.class.getName());
    ...
    public JDlgConsultaVendedor(java.awt.Frame parent, boolean modal) {
        ...
        consultarVendedor = new ConsultaVendedor_efb();
        VendedorDao = new VendedorDao_efb();

        lista = new ArrayList();
        consultarVendedor.setList(lista);
        jTable1.setModel(consultarVendedor);
    }
